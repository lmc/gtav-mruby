...
class GUI::Table < Struct.new(:x, :y, :w, :h, :rh, :widths, :data, :p, :pco, :pci, :pro, :pri, :cell_text, :header_row_text, :body_row_text, :tr, :tg, :tb, :ta, :cr, :cg, :cb, :ca)
  def initialize(options = {})
    ...
    self.cell_text = options[:cell_text] || GUI::Text.new(font: 4, scale2: 1.3)
